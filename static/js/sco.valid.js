...
;(function($, undefined) {
	...
	$.extend(Valid.prototype, {
		...
		messages: {
			not_empty: '<font color="#FF0000">不能为空，请填入内容�?</font>'
				,min_length: '<font color="#FF0000">请输入至�? :value 个字母�?</font>'
				,max_length: '<font color="#FF0000">请输入少�? :value 个字母�?</font>'
			,regex: ''
			,email: '<font color="#FF0000">请输入正确的Email地址�?</font>'
			,url: '<font color="#FF0000">请输入正确的URL�?</font>'
			,exact_length: '<font color="#FF0000">请输入正确的 :value 个字母�?</font>'
			,equals: '<font color="#FF0000">请输入正确值�?</font>'
			,ip: '<font color="#FF0000">请输入IP�?</font>'
			,credit_card: '<font color="#FF0000">请输入正确的信用卡号码�?</font>'
			,alpha: ''
			,alpha_numeric: ''
			,alpha_dash: ''
			,digit: '<font color="#FF0000">Please enter only digits.</font>'
			,numeric: '<font color="#FF0000">请输入数值�?</font>'
			,decimal: '<font color="#FF0000">Please enter a decimal number.</font>'
			,matches: '<font color="#FF0000">必须和前值一致�?</font>'
